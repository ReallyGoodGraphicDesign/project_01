function ContentSection({ title, subtitle, children }) {
  return (
    <section className="rounded-[0.25rem] bg-zinc-500 p-8 shadow-[0_40px_120px_-40px_rgba(15,23,42,0.9)] transition duration-300 hover:-translate-y-0.5 hover:bg-zinc-600 sm:p-10">
